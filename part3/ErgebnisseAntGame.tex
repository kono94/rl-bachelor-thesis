...
\begin{figure}[H]
    ...
    \captionof{figure}{Durschnittliche Belohnung pro Zeitstempel bei $\gamma = 0.5$ und $\epsilon = 0.15$}
    \label{fig:test1}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionof{figure}{Durschnittliche Belohnung pro Zeitstempel bei $\gamma = 0.9$ und $\epsilon = 0.15$}
    \label{fig:gamma09}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionof{figure}{Durschnittliche Belohnung pro Zeitstempel bei $\gamma = 0.99$ und $\epsilon = 0.15$}
    \label{fig:test1}
\end{figure}
